...
def main():
    ...
    while True:
        choice = input("1 - Insert, 2 - Search document, 3 - Change collection, 4 - Delete, 0 - Exit: ").strip()
        ...
        if choice == "0":
            ...
            value = input("Enter search value (regex supported): ").strip()
            ...
            key = input("Enter delete key: ").strip()
            value = input("Enter delete value (regex supported): ").strip()
            ...
            print(f"Deleted from MongoDB: {result.deleted_count}")
